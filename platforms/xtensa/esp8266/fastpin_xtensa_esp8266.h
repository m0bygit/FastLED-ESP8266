#ifndef __FASTPIN_XTENSA_ESP8266_H
#define __FASTPIN_XTENSA_ESP8266_H
...
template<uint8_t PIN, uint8_t _BIT, uint32_t _MASK, typename _GPIO> class _XTENSAPIN {
public:
...
#define _DEFPIN_XTENSA(PIN, BIT, L) template<> class FastPin<PIN> : public _XTENSAPIN<PIN, BIT, 1 << BIT, _R(GPIO ## L)> {};
...
#define MAX_PIN 19
_DEFPIN_XTENSA(0, 7, B);
_DEFPIN_XTENSA(1, 6, B);
_DEFPIN_XTENSA(2, 5, B);
_DEFPIN_XTENSA(3, 4, B);
_DEFPIN_XTENSA(4, 3, B);
_DEFPIN_XTENSA(5, 15, A);
_DEFPIN_XTENSA(6, 14, A);
_DEFPIN_XTENSA(7, 13, A);
_DEFPIN_XTENSA(8, 8, A);
_DEFPIN_XTENSA(9, 9, A);
_DEFPIN_XTENSA(10, 0, A);
_DEFPIN_XTENSA(11, 1, A);
_DEFPIN_XTENSA(12, 4, A);
_DEFPIN_XTENSA(13, 5, A);
_DEFPIN_XTENSA(14, 6, A);
_DEFPIN_XTENSA(15, 7, A);
_DEFPIN_XTENSA(16, 0, B);
_DEFPIN_XTENSA(17, 1, B);
_DEFPIN_XTENSA(18, 3, A);
_DEFPIN_XTENSA(19, 2, A);
...
#endif // __INC_FASTPIN_XTENSA_ESP8266
